...
function ext_civicrm_install() {
  return _ext_civix_civicrm_install();
}
...
function ext_civicrm_uninstall() {
  return _ext_civix_civicrm_uninstall();
}
...
function ext_civicrm_enable() {
  return _ext_civix_civicrm_enable();
}
...
function ext_civicrm_disable() {
  return _ext_civix_civicrm_disable();
}
...
function ext_civicrm_managed(&$entities) {
  return _ext_civix_civicrm_managed($entities);
}
